...
import SEO, { generateFAQSchema, generateHowToSchema } from "@/components/SEO";
...
export default function SignUp() {
  ...
  const faqSchema = generateFAQSchema(
    signUpFAQs.map((faq) => ({ question: faq.question, answer: faq.answer })),
  );
  const howToSchema = generateHowToSchema([
    { name: "Choose your account type", text: "Select whether you want a personal or enterprise FinanceAI account." },
    { name: "Fill in your details", text: "Add your name, country, and email address to start your profile." },
    { name: "Create a secure password", text: "Use a strong password that satisfies all password requirements." },
    { name: "Accept the terms", text: "Review and accept the Terms of Service and Privacy Policy before continuing." },
  ]);

  return (
    <>
      <SEO
        title="Create Your FinanceAI Account"
        description="Sign up for FinanceAI to track spending, manage subscriptions, and receive AI-powered financial guidance."
        canonical="/signup"
        schema={{
